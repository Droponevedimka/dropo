...
// errEngineNotImplemented is returned by scaffolded (not-yet-implemented) OS
// engines so callers get an honest, typed failure instead of a silent no-op.
var errEngineNotImplemented = errors.New("interception engine is not yet implemented on this platform")
