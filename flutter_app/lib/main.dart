...
class _CompatibilityNoticeAction {
  const _CompatibilityNoticeAction({
    required this.openDropoSpace,
      ...
      child: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            ...
            onChanged: (value) {
              setState(() => doNotShowAgain = value == true);
            },
            title: const Text(
              'Больше не показывать',
              style: TextStyle(color: Color(0xFFD8E4E0), fontSize: 12),
            ),
          ),
          const SizedBox(height: 12),
          Row(
              ...
              Expanded(
                child: _ActionButton(
                  ...
                  onPressed: () => widget.onDecision(
                    _CompatibilityNoticeAction(
                      openDropoSpace: false,
